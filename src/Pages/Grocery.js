...
// import Demo from "../Images/demo1.jpg"
  ...
  render() {
    return (
        ...
        <div className="main-card-body">
            <h1 className='heading-1'>Essential Kitchen</h1>
        ...
        <div className="main-card-body">
            <h1 className='heading-1'>Backery</h1>
            <div className="card-wrapper">
                <div className="cards">
                    <Card style={{ width: '18rem' }}>
                        <Card.Img variant="top" src= {wheat} className='card-img'/>
        ...
        <div className="main-card-body">
            <h1 className='heading-1'>Quick Snacks</h1>
            <div className="card-wrapper">
                <div className="cards">
                    <Card style={{ width: '18rem' }}>
                        <Card.Img variant="top" src= {wheat} className='card-img'/>
        ...
        <div className="main-card-body">
            <h1 className='heading-1'>Spices</h1>
            <div className="card-wrapper">
                <div className="cards">
                    <Card style={{ width: '18rem' }}>
                        <Card.Img variant="top" src= {wheat} className='card-img'/>
